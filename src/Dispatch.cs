...
namespace B4_Plastics_SMS
{
    public partial class Dispatch : Form
    {
        ...
        DispatchDashboard myDashboard = new DispatchDashboard();
        frmUserProfile myUserProfile;
        Stock myStock = new Stock();
        DispatchQuantity myDispatchQuantity = new DispatchQuantity();
        ...
        public void ButtonColourEffect(Button btnClicked)
        {
            if (btnClicked != null)
            {
                ...
                btnDispatchPage.BackColor = Color.FromArgb(37, 45, 55);
                btnCalculateLoad.BackColor = Color.FromArgb(37, 45, 55);
        ...
        private void btnDashboard_Click_1(object sender, EventArgs e)
        {
            ...
            myDashboard = new DispatchDashboard();
            ButtonFormChage(myDashboard);
        ...
        private void btnDispatchPage_Click(object sender, EventArgs e)
        {
            ...
            // Medthod for changing form
            ButtonFormChage(myDispatchQuantity);
        }

        private void btnCalculateLoad_Click(object sender, EventArgs e)
        {
            lblHeading.Text = "Calculate Load";
            // Colour Effects for clicking on button 
            ButtonColourEffect(sender as Button);
            //------------------------------------

            // Medthod for changing form
            ButtonFormChage(calculateLoad);
        }
